...
const Community = () => {
  return (
      ...
      <Head name="Community"/>
      <div className="w-full p-[15px] h-[calc(100vh-60px)]">

       <div className="flex w-full justify-between items-center">
        <div className="w-full text-lg font-bold">Different TCN Women Whatsapp  Group Link</div>
        <div className="w-auto flex items-center gap-1">
            <FaSearch className="text-teal-500" />
            <input
             className="p-2 bg-transparent outline-none text-teal-500 border-b-2 duration-300 border-pink-500 placeholder-teal-500"
              placeholder="Search WhatsApp Link..."
            />
          </div>
       </div>
       <div className="w-full h-[480px] bg-white mt-[10px] p-[20px]">
             <span className=" text-[20px] flex font-extrabold mb-[10px]">35 Whatsapp Link</span>
   
             <div className="flex gap-4 flex-wrap">
      {Data.map((props, index)=>(
           
             <div className="w-[200px] h-[200px] bg-gray-50 rounded-md cursor-pointer pb-[10px] " key={index}>
               <div className="w-full h-[120px] rounded-s-sm overflow-hidden">
                 ...
                 <div className="flex flex-col text-[13px]">
                   <span className="font-extrabold text-[15px] mt-[3px] mb-[-3px]">{props.centre}</span>
                 ...
                 <div className="border-2 border-gray-100 py-[3px] px-[5px] rounded-[6px] bg-gradient-to-r from-teal-500 to-pink-600 text-white shadow-lg cursor-pointer object-cover hover:border-gray-200">
